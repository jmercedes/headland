...
Refinery::Core.configure do |config|
  ...
  # Site name
  config.site_name = "Mersa Construcciones Ligeras"
  ...
  config.google_analytics_page_code = "UA-45097602-1"
  ...
  # config.dragonfly_secret = "6e6dae264f2fa0562438491b77ea9a996cfeed4122e85122"
